...
let ArrowCircleDownIcon = (_dec = customElement({
  name: 'arrow-circle-down-icon',
...
`
}), _dec(_class = (_class2 = class ArrowCircleDownIcon {
  constructor() {
...
export { ArrowCircleDownIcon as default };