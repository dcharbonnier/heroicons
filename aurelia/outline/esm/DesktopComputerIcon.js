...
let DesktopComputerIcon = (_dec = customElement({
  name: 'desktop-computer-icon',
...
`
}), _dec(_class = (_class2 = class DesktopComputerIcon {
  constructor() {
...
export { DesktopComputerIcon as default };