...
let DotsCircleHorizontalIcon = (_dec = customElement({
  name: 'dots-circle-horizontal-icon',
...
`
}), _dec(_class = (_class2 = class DotsCircleHorizontalIcon {
  constructor() {
...
export { DotsCircleHorizontalIcon as default };