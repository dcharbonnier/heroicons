...
let ArrowCircleLeftIcon = (_dec = customElement({
  name: 'arrow-circle-left-icon',
...
`
}), _dec(_class = (_class2 = class ArrowCircleLeftIcon {
  constructor() {
...
export { ArrowCircleLeftIcon as default };