...
let ArrowCircleRightIcon = (_dec = customElement({
  name: 'arrow-circle-right-icon',
...
`
}), _dec(_class = (_class2 = class ArrowCircleRightIcon {
  constructor() {
...
export { ArrowCircleRightIcon as default };