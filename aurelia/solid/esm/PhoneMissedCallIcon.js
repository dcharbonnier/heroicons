...
let PhoneMissedCallIcon = (_dec = customElement({
  name: 'phone-missed-call-icon',
...
`
}), _dec(_class = (_class2 = class PhoneMissedCallIcon {
  constructor() {
...
export { PhoneMissedCallIcon as default };