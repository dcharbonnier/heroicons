...
let DocumentDownloadIcon = (_dec = customElement({
  name: 'document-download-icon',
...
`
}), _dec(_class = (_class2 = class DocumentDownloadIcon {
  constructor() {
...
export { DocumentDownloadIcon as default };