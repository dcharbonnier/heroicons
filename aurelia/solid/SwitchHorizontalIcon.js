...
let SwitchHorizontalIcon = (_dec = customElement({
  name: 'switch-horizontal-icon',
...
`
}), _dec(_class = (_class2 = class SwitchHorizontalIcon {
  constructor() {
...
export { SwitchHorizontalIcon as default };